...
<body class="bg-paper text-ink min-h-screen flex items-center justify-center px-4">
    ...
    <div class="w-full max-w-sm">
        <div class="text-center mb-8">
            ...
            <div class="text-sm" style="color: rgba(26,26,26,0.55);">Manager Portal — Enter your PIN</div>
        </div>
        ...
        <div class="k-card k-shadow p-8">
            ...
            <form method="POST" action="{{ route('dashboard.pin.submit') }}">
                @csrf
        ...
        <div class="text-center mt-4 text-xs" style="color: rgba(26,26,26,0.45);">
            <a href="{{ route('dashboard.login') }}" class="underline">← Back to sign in</a>
        </div>
    </div>
